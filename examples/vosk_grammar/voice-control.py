# This example showcases how to use voice-control with a reduced grammar set.
#
...
# almost 100% accurate.
#
# This is the command that I used to invoke voice-control for development and
...
#      --numbers-as-digits  \
#      --numbers-no-suffix  \
#      --vosk-model-dir     ~/.config/voice-control/vosk-model-en-us-0.22-lgraph/ \
#      --vosk-grammar-file  ./examples/vosk_grammar/vosk-grammar.json              \
#      --config             ./examples/vosk_grammar/voice-control.py
#
