...
# found it useful to work with voice-control.)
#
# Language Tool is a free service (or local server for the paranoid!) for low
# request volume and I have added it to my voice-control configuration to
...
#    Rule: I_LOWERCASE
#
# voice-control was invoked as follows:
#    ./voice-control begin --config ./examples/language_tool/voice-control.py
#
